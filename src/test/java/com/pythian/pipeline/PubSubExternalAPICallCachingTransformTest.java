...
import com.pythian.pipeline.PubSubExternalAPICallCaching.EnrichWithExternalCall;
import com.pythian.pipeline.dto.OutputSensorData;
import com.pythian.pipeline.transformations.TransformToSensorData;

public class PubSubExternalAPICallCachingTransformTest {
	...
	public void testPipeline() {
		...
		PCollection<String> results = 
			pipeline
				...
				.apply("EnrichWithExternalCall", ParDo.of(new EnrichWithExternalCall(false, "localhost:11211", 60, weatherApiKey)));
